...
1. **Frontend:** SPA utilizando Material UI para garantir responsividade e validações em tempo real.
2. **Backend:** Construído em Node.js seguindo o padrão REST, com separação clara entre rotas e lógica.
3. **Database:** Persistência em MySQL remoto (Aiven), com restrição de e-mail único (UNIQUE).
